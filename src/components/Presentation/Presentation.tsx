...
export const Presentation = () => {
  ...
  useEffect(() => {
    const countDownDate = new Date('2025-04-04T21:00').getTime()
  ...
  return (
    <div className="max-w-2xl mx-auto relative flex flex-col items-center overflow-hidden text-white font-bold">
      ...
      <div className="absolute text-center presentation--text">
        <h3 className="font-normal presentation--title">¡Nos Casamos!</h3>
        <h1 className="mt-4 presentation--name">Daniel y Zulema</h1>
      </div>
